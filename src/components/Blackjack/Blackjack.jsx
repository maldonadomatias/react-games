    ...
    render() {
      ...
      return (
        <div className='blackjackContainer'>
          ...
          <p className='blackjackText'>Wallet: ${this.state.wallet}</p>
          ...
          <p className='blackjackText'>Your Hand ({this.state.player.count})</p>
          ...
          <p className='blackjackText'>Dealer's Hand ({this.state.dealer.count})</p>
          <table className="cards">
            <tr>
          ...
          <p className='blackjackText'>{this.state.message}</p>
        </div>
      );
    }
  }
